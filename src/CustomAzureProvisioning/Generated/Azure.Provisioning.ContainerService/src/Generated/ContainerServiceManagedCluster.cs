...
public partial class ContainerServiceManagedCluster : ProvisionableResource
{
    ...
    public ContainerServiceManagedCluster(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.ContainerService/managedClusters", resourceVersion ?? "2024-10-01")
    {
    }
    ...
    protected override void DefineProvisionableProperties()
    {
        ...
        _aadProfile = DefineModelProperty<ManagedClusterAadProfile>("AadProfile", ["AadProfile"]);
        _addonProfiles = DefineDictionaryProperty<ManagedClusterAddonProfile>("AddonProfiles", ["AddonProfiles"]);
        _agentPoolProfiles = DefineListProperty<ManagedClusterAgentPoolProfile>("AgentPoolProfiles", ["AgentPoolProfiles"]);
        _apiServerAccessProfile = DefineModelProperty<ManagedClusterApiServerAccessProfile>("ApiServerAccessProfile", ["ApiServerAccessProfile"]);
        _autoScalerProfile = DefineModelProperty<ManagedClusterAutoScalerProfile>("AutoScalerProfile", ["AutoScalerProfile"]);
        _autoUpgradeProfile = DefineModelProperty<ManagedClusterAutoUpgradeProfile>("AutoUpgradeProfile", ["AutoUpgradeProfile"]);
        _azureMonitorMetrics = DefineModelProperty<ManagedClusterMonitorProfileMetrics>("AzureMonitorMetrics", ["AzureMonitorMetrics"]);
        _clusterIdentity = DefineModelProperty<ManagedClusterIdentity>("ClusterIdentity", ["ClusterIdentity"]);
        _disableLocalAccounts = DefineProperty<bool>("DisableLocalAccounts", ["DisableLocalAccounts"]);
        _diskEncryptionSetId = DefineProperty<ResourceIdentifier>("DiskEncryptionSetId", ["DiskEncryptionSetId"]);
        _dnsPrefix = DefineProperty<string>("DnsPrefix", ["DnsPrefix"]);
        _enablePodSecurityPolicy = DefineProperty<bool>("EnablePodSecurityPolicy", ["EnablePodSecurityPolicy"]);
        _enableRbac = DefineProperty<bool>("EnableRbac", ["EnableRbac"]);
        _extendedLocation = DefineModelProperty<ExtendedAzureLocation>("ExtendedLocation", ["ExtendedLocation"]);
        _fqdnSubdomain = DefineProperty<string>("FqdnSubdomain", ["FqdnSubdomain"]);
        _httpProxyConfig = DefineModelProperty<ManagedClusterHttpProxyConfig>("HttpProxyConfig", ["HttpProxyConfig"]);
        _identityProfile = DefineDictionaryProperty<ContainerServiceUserAssignedIdentity>("IdentityProfile", ["IdentityProfile"]);
        _kubernetesVersion = DefineProperty<string>("KubernetesVersion", ["KubernetesVersion"]);
        _linuxProfile = DefineModelProperty<ContainerServiceLinuxProfile>("LinuxProfile", ["LinuxProfile"]);
        _networkProfile = DefineModelProperty<ContainerServiceNetworkProfile>("NetworkProfile", ["NetworkProfile"]);
        _nodeResourceGroup = DefineProperty<string>("NodeResourceGroup", ["NodeResourceGroup"]);
        _oidcIssuerProfile = DefineModelProperty<ManagedClusterOidcIssuerProfile>("OidcIssuerProfile", ["OidcIssuerProfile"]);
        _podIdentityProfile = DefineModelProperty<ManagedClusterPodIdentityProfile>("PodIdentityProfile", ["PodIdentityProfile"]);
        _privateLinkResources = DefineListProperty<ContainerServicePrivateLinkResourceData>("PrivateLinkResources", ["PrivateLinkResources"]);
        _publicNetworkAccess = DefineProperty<ContainerServicePublicNetworkAccess>("PublicNetworkAccess", ["PublicNetworkAccess"]);
        _securityProfile = DefineModelProperty<ManagedClusterSecurityProfile>("SecurityProfile", ["SecurityProfile"]);
        _serviceMeshProfile = DefineModelProperty<ServiceMeshProfile>("ServiceMeshProfile", ["ServiceMeshProfile"]);
        _servicePrincipalProfile = DefineModelProperty<ManagedClusterServicePrincipalProfile>("ServicePrincipalProfile", ["ServicePrincipalProfile"]);
        _sku = DefineModelProperty<ManagedClusterSku>("Sku", ["Sku"]);
        _storageProfile = DefineModelProperty<ManagedClusterStorageProfile>("StorageProfile", ["StorageProfile"]);
        _supportPlan = DefineProperty<KubernetesSupportPlan>("SupportPlan", ["SupportPlan"]);
        _tags = DefineDictionaryProperty<string>("Tags", ["tags"]);
        _upgradeOverrideSettings = DefineModelProperty<UpgradeOverrideSettings>("UpgradeOverrideSettings", ["UpgradeOverrideSettings"]);
        _windowsProfile = DefineModelProperty<ManagedClusterWindowsProfile>("WindowsProfile", ["WindowsProfile"]);
        _workloadAutoScalerProfile = DefineModelProperty<ManagedClusterWorkloadAutoScalerProfile>("WorkloadAutoScalerProfile", ["WorkloadAutoScalerProfile"]);
        _azurePortalFqdn = DefineProperty<string>("AzurePortalFqdn", ["AzurePortalFqdn"], isOutput: true);
        _currentKubernetesVersion = DefineProperty<string>("CurrentKubernetesVersion", ["CurrentKubernetesVersion"], isOutput: true);
        _fqdn = DefineProperty<string>("Fqdn", ["Fqdn"], isOutput: true);
        _id = DefineProperty<ResourceIdentifier>("Id", ["id"], isOutput: true);
        _maxAgentPools = DefineProperty<int>("MaxAgentPools", ["MaxAgentPools"], isOutput: true);
        _powerStateCode = DefineProperty<ContainerServiceStateCode>("PowerStateCode", ["PowerStateCode"], isOutput: true);
        _privateFqdn = DefineProperty<string>("PrivateFqdn", ["PrivateFqdn"], isOutput: true);
