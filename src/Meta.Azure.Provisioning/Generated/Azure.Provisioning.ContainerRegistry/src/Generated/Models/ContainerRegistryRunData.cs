...
public partial class ContainerRegistryRunData : ProvisionableConstruct
{
    ...
    protected override void DefineProvisionableProperties()
    {
        ...
        _runId = DefineProperty<string>("RunId", ["RunId"]);
        _status = DefineProperty<ContainerRegistryRunStatus>("Status", ["Status"]);
        _lastUpdatedOn = DefineProperty<DateTimeOffset>("LastUpdatedOn", ["LastUpdatedOn"]);
        _runType = DefineProperty<ContainerRegistryRunType>("RunType", ["RunType"]);
        ...
        _finishOn = DefineProperty<DateTimeOffset>("FinishOn", ["FinishOn"]);
        _outputImages = DefineListProperty<ContainerRegistryImageDescriptor>("OutputImages", ["OutputImages"]);
        _task = DefineProperty<string>("Task", ["Task"]);
        _imageUpdateTrigger = DefineModelProperty<ContainerRegistryImageUpdateTrigger>("ImageUpdateTrigger", ["ImageUpdateTrigger"]);
        _sourceTrigger = DefineModelProperty<ContainerRegistrySourceTriggerDescriptor>("SourceTrigger", ["SourceTrigger"]);
        _timerTrigger = DefineModelProperty<ContainerRegistryTimerTriggerDescriptor>("TimerTrigger", ["TimerTrigger"]);
        ...
        _sourceRegistryAuth = DefineProperty<string>("SourceRegistryAuth", ["SourceRegistryAuth"]);
        _customRegistries = DefineListProperty<string>("CustomRegistries", ["CustomRegistries"]);
        _runErrorMessage = DefineProperty<string>("RunErrorMessage", ["RunErrorMessage"], isOutput: true);
        _updateTriggerToken = DefineProperty<string>("UpdateTriggerToken", ["UpdateTriggerToken"]);
        _logArtifact = DefineModelProperty<ContainerRegistryImageDescriptor>("LogArtifact", ["LogArtifact"], isOutput: true);
        _provisioningState = DefineProperty<ContainerRegistryProvisioningState>("ProvisioningState", ["ProvisioningState"]);
