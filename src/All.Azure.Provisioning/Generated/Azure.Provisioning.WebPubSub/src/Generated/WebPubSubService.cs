...
public partial class WebPubSubService : ProvisionableResource
{
    ...
    protected override void DefineProvisionableProperties()
    {
        ...
        _isAadAuthDisabled = DefineProperty<bool>("IsAadAuthDisabled", ["IsAadAuthDisabled"]);
        _isClientCertEnabled = DefineProperty<bool>("IsClientCertEnabled", ["IsClientCertEnabled"]);
        _isLocalAuthDisabled = DefineProperty<bool>("IsLocalAuthDisabled", ["IsLocalAuthDisabled"]);
        _liveTraceConfiguration = DefineModelProperty<LiveTraceConfiguration>("LiveTraceConfiguration", ["LiveTraceConfiguration"]);
        _networkAcls = DefineModelProperty<WebPubSubNetworkAcls>("NetworkAcls", ["NetworkAcls"]);
        _publicNetworkAccess = DefineProperty<string>("PublicNetworkAccess", ["PublicNetworkAccess"]);
        _resourceLogCategories = DefineListProperty<ResourceLogCategory>("ResourceLogCategories", ["ResourceLogCategories"]);
        _sku = DefineModelProperty<BillingInfoSku>("Sku", ["Sku"]);
        _tags = DefineDictionaryProperty<string>("Tags", ["tags"]);
        _externalIP = DefineProperty<string>("ExternalIP", ["ExternalIP"], isOutput: true);
        _hostName = DefineProperty<string>("HostName", ["HostName"], isOutput: true);
        _hostNamePrefix = DefineProperty<string>("HostNamePrefix", ["HostNamePrefix"], isOutput: true);
        _id = DefineProperty<ResourceIdentifier>("Id", ["id"], isOutput: true);
        _privateEndpointConnections = DefineListProperty<WebPubSubPrivateEndpointConnectionData>("PrivateEndpointConnections", ["PrivateEndpointConnections"], isOutput: true);
        _provisioningState = DefineProperty<WebPubSubProvisioningState>("ProvisioningState", ["ProvisioningState"], isOutput: true);
        _publicPort = DefineProperty<int>("PublicPort", ["PublicPort"], isOutput: true);
        _serverPort = DefineProperty<int>("ServerPort", ["ServerPort"], isOutput: true);
        _sharedPrivateLinkResources = DefineListProperty<WebPubSubSharedPrivateLinkData>("SharedPrivateLinkResources", ["SharedPrivateLinkResources"], isOutput: true);
